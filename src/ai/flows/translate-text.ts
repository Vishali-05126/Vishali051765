...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a highly skilled translator. Translate the following text into {{{targetLanguage}}}. Only return the translated text, without any additional comments or explanations.
